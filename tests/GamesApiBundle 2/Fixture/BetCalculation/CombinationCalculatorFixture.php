...
/**
 * Class CombinationCalculatorFixture
 */
final class CombinationCalculatorFixture extends Fixture
{
    /**
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $bet1
            ->setAmount(1.5)
             ->getOdd()->setClass('COUNT_WHITE_MORE_BLUE')
        ;
        $manager->persist($bet1->getOdd());
